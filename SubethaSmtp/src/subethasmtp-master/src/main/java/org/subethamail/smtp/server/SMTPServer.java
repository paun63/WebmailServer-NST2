...
public class SMTPServer
{
	...
	public int port = 25;	// default to 25
	public String hostName;	// defaults to a lookup of the local address
	private int backlog = 50;
	private String softwareName = "SubEthaSMTP " + Version.getSpecification();

	private MessageHandlerFactory messageHandlerFactory;
	public AuthenticationHandlerFactory authenticationHandlerFactory;
